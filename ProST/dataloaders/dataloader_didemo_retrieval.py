...
class DiDeMo_DataLoader(Dataset):
    def __init__(
        ...
        video_id_path_dict = {}
        video_id_path_dict["train"] = os.path.join(self.data_path, "train_list_mp4.txt")
        video_id_path_dict["val"] = os.path.join(self.data_path, "test_list_mp4.txt")
        video_id_path_dict["test"] = os.path.join(self.data_path, "test_list_mp4.txt")

        video_json_path_dict = {}
        video_json_path_dict["train"] = os.path.join(self.data_path, "train_data_mp4.json")
        video_json_path_dict["val"] = os.path.join(self.data_path, "test_data_mp4.json")
        video_json_path_dict["test"] = os.path.join(self.data_path, "test_data_mp4.json")
