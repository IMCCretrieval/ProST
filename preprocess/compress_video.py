...
def prepare_mp4_pairs(input_root, output_root):
    ...
    for root, dirs, files in os.walk(input_root):
        for file_name in files:
            ...
            output_video_path = output_video_path.split('.')[0] +'.mp4'
...
if __name__ == "__main__":
    ...
    # input_video_path_list, output_video_path_list = prepare_mp4_pairs(input_root, output_root)
    ...
    print("Compress mp4 finished, wait for checking files...")
